package com.sptek._frameworkWebCore.config.springSecurity.test;
...
import com.sptek._frameworkWebCore.config.springSecurity.CustomJwtFilter;
import com.sptek._frameworkWebCore.config.springSecurity.GeneralTokenProvider;
import com.sptek._frameworkWebCore.config.springSecurity.extras.dto.LoginRequestDto;
...
public class SecurityApiController {
    ...
    @PreAuthorize(
            "hasAuthority(T(com.sptek._frameworkWebCore.config.springSecurity.AuthorityIfEnum).AUTH_RETRIEVE_USER_ALL_FOR_MARKETING)"
    )
    ...
    @PreAuthorize(
            "hasAuthority(T(com.sptek._frameworkWebCore.config.springSecurity.AuthorityIfEnum).AUTH_RETRIEVE_USER_ALL_FOR_DELIVERY)"
    )
    ...
    @PreAuthorize(
            "hasAuthority(T(com.sptek._frameworkWebCore.config.springSecurity.AuthorityIfEnum).AUTH_SPECIAL_FOR_TEST)"
    )
