package com.sptek._frameworkWebCore.config.encryption;
...
public class AesEncryptor {
    ...
    AesEncryptor(@Value("${aesEncryptor.base64SecretKey}") String base64SecretKey) {
        byte[] secretKeyByte = Base64.getDecoder().decode(base64SecretKey);
        this.secretKey = new SecretKeySpec(secretKeyByte, AES);
    }
