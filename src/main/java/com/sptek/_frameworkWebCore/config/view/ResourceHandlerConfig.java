package com.sptek._frameworkWebCore.config.view;
...
public class ResourceHandlerConfig implements WebMvcConfigurer {
    ...
    public void addResourceHandlers(ResourceHandlerRegistry resourceHandlerRegistry) {
        ...
        resourceHandlerRegistry.addResourceHandler("/_frameworkWebCore/**").addResourceLocations("classpath:/_frameworkWebCore/").setCacheControl(cacheControl);
