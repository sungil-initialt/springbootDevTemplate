...
public class LocaleConfig implements WebMvcConfigurer {
    ...
    public LocaleResolver localeResolver() {
        CookieLocaleResolver cookieLocaleResolver = new CookieLocaleResolver(CommonConstants.LOCALE_NAME);
        // 서버 기준으로 디폴트
    ...
    //    cookieLocaleResolver.setCookieMaxAge(Duration.ofSeconds(CommonConstants.LOCALE_COOKIE_MAX_AGE_DAY)); //비 설정시 session 으로 적용됨
    //
    //    return cookieLocaleResolver;
    //}
    ...
    public CustomLocaleChangeInterceptor localeChangeInterceptor() {
        ...
        customLocaleChangeInterceptor.setParamName(CommonConstants.LOCALE_NAME);
