...
public class PreventDuplicateRequestAspect {
    ...
    @Pointcut("@within(org.springframework.web.bind.annotation.RestController) " +
            "&& (@within(com.sptek._frameworkWebCore.annotation.EnablePreventDuplicateRequest_InRestController_RestControllerMethod) || @annotation(com.sptek._frameworkWebCore.annotation.EnablePreventDuplicateRequest_InRestController_RestControllerMethod))")
